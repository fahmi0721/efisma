...
Route::group(['middleware' => ['auth','entitas_scope']], function () {
    Route::prefix('jurnal')->group(function() {
        ...
        Route::get('/kas-keluar/template', [UploadJurnalController::class, 'template_kaskeluar'])->name('jurnal.kaskeluar.template')->middleware('permission:kas_keluar.upload');
        Route::post('/kas-keluar/upload/save', [UploadJurnalController::class, 'kaskeluar'])->name('jurnal.kaskeluar.upload.save')->middleware('permission:kas_keluar.upload');
        ...
        Route::get('/penyesuaian/template', [UploadJurnalJPController::class, 'template'])->name('jurnal.penyesuaian.template')->middleware('permission:penyesuaian.create');
        Route::post('/penyesuaian/upload/save', [UploadJurnalJPController::class, 'upload'])->name('jurnal.penyesuaian.upload.save')->middleware('permission:penyesuaian.create');
        /**End */
