@extends('layouts.app')
@section('title','Create New Cabang')
@section('breadcrumb')
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Create New Cabang</h5></div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-8">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Create New Cabang</div></div>
                <!--end::Header-->
                <!--begin::Form-->
                <form action='javascript:void(0)' enctype="multipart/form-data" id="form_data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control" rows='5' id="deskripsi" name="deskripsi" placeholder="Deskripsi"></textarea>
                            </div>
                        </div>
                    </div>
                    <!--end::Body-->
