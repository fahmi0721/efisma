@extends('layouts.app')
@section('title','Update Periode Akuntansi')
@section('breadcrumb')
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Update Periode Akuntansi</h5></div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ route('periode_akuntansi') }}">Periode Akuntansi</a></li>
    ...
    <div class="row">
        <div class="col-8">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Update Periode Akuntansi</div></div>
                <!--end::Header-->
                <!--begin::Form-->
                <form action='javascript:void(0)' enctype="multipart/form-data" id="form_data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="periode" name="periode" class="form-control" 
                                       placeholder="Pilih periode (YYYY-MM)" value="{{ $data->periode }}" readonly>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                      <a href="{{ route('periode_akuntansi') }}" class="btn btn-danger btn-flat btn-sm"><i class="fa fa-mail-reply"></i> Kembali</a>
...
<script>
    ...
    proses_data = function(){
        ...
        $.ajax({
            type    : "POST",
            url     : "{{ route('periode_akuntansi.update', ':id') }}".replace(':id', id),
            data    : iData,
            cache   : false,
            processData: false,
            contentType: false,
            ...
            success: function(result){
                ...
                if(result.status == "success"){
                    ...
                    setTimeout(() => {
                        window.location.href = "{{ route('periode_akuntansi') }}";
                    }, 2000);
