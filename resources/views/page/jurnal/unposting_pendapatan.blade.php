@extends('layouts.app')
@section('title','Unposting Jurnal Pendapatan')

@section('breadcrumb')
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h5 class="mb-2">Unposting Jurnal Pendapatan</h5></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('jurnal.pendapatan') }}">Jurnal Pendapatan</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Unposting Jurnal Pendapatan</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Unposting Jurnal Pendapatan</div></div>
...
function load_data(){
    $('#t_data').DataTable({
        ...
        responsive: true,
        ajax: {
            url: "{{ route('jurnal.pendapatan.unposting') }}",
            data: function (d) {
