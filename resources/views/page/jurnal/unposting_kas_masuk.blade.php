@extends('layouts.app')
@section('title','Unposting Jurnal Kas Masuk')

@section('breadcrumb')
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h5 class="mb-2">Unposting Jurnal Kas Masuk</h5></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('jurnal.kasmasuk') }}">Jurnal Kas Masuk</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Unposting Jurnal Kas Masuk</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Unposting Jurnal Kas Masuk</div></div>
...
function load_data(){
    $('#t_data').DataTable({
        ...
        responsive: true,
        ajax: {
            url: "{{ route('jurnal.kasmasuk.unposting') }}",
            data: function (d) {
