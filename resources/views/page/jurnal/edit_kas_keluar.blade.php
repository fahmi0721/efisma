@extends('layouts.app')
@section('title','Update Jurnal Kas Keluar')

@section('breadcrumb')
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h5 class="mb-2">Update Jurnal Kas Keluar</h5></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('jurnal.kaskeluar') }}">Jurnal Kas Keluar</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Update Jurnal Kas Keluar</li>
                </ol>
            </div>
        </div>
    </div>
...
function proses_data(confirmSave = false) {
    ...
    $.ajax({
        ...
        type: "POST",
        url     : "{{ route('jurnal.update', [':id','JKK']) }}".replace(':id', id),
        data: iData,
        cache: false,
        processData: false,
        contentType: false,
