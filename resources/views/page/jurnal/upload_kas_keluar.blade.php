@extends('layouts.app')
@section('title','Upload Jurnal Kas Keluar')

@section('breadcrumb')
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h5 class="mb-2">Upload Jurnal Kas Keluar</h5></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('jurnal.kaskeluar') }}">Jurnal Kas Keluar</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Upload Jurnal Kas Keluar</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header d-flex align-items-center">
                    <h5 class="mb-0">Upload Jurnal Kas Keluar</h5>
                    <div class="ms-auto">
                        <a href="javascript:void(0)" onclick="get_template()" class="btn btn-success btn-sm">
                            <i class="fas fa-file-excel fa-regular"></i> Download Template
                        </a>
