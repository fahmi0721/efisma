@extends('layouts.app')
@section('title','Posting Jurnal Kas Keluar')

@section('breadcrumb')
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h5 class="mb-2">Posting Jurnal Kas Keluar</h5></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('jurnal.kaskeluar') }}">Jurnal Kas Keluar</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Posting Jurnal Kas Keluar</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Posting Jurnal Kas Keluar</div></div>
...
function load_data(){
    $('#t_data').DataTable({
        ...
        responsive: true,
        ajax: {
            url: "{{ route('jurnal.kaskeluar.posting') }}",
            data: function (d) {
