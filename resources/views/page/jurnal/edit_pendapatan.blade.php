@extends('layouts.app')
@section('title','Update Jurnal Pendapatan')

@section('breadcrumb')
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h5 class="mb-2">Update Jurnal Pendapatan</h5></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('jurnal.pendapatan') }}">Jurnal Pendapatan</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Update Jurnal Pendapatan</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Update Jurnal Pendapatan</div></div>
                ...
                <form action="javascript:void(0)" enctype="multipart/form-data" id="form_data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ $data->no_resi }}"  class="form-control" id="no_resi" name="no_resi" placeholder="Resi Pengiriman" />
                            </div>
                        </div>
...
function proses_data(){
    ...
    $.ajax({
        ...
        type: "POST",
        url     : "{{ route('jurnal.update', [':id','JP']) }}".replace(':id', id),
        data: iData,
        cache: false,
        processData: false,
        contentType: false,
