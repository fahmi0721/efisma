...
class UploadJurnalService
{

    public static function kaskeluar($request){
        DB::beginTransaction();
    ...
    private static function prosesJurnalHeaderDanDetail($spreadsheet, $request, array $detailGroup)
    {
        ...
        for ($row = 3; $row <= $highestRow; $row++) {
            ...
            $jurnalHeader = JurnalHeader::create([
                'kode_jurnal'  => self::generateKodeJurnalKasKeluar(),
                'jenis'        => 'JKK',
    ...
    private static function generateKodeJurnalKasKeluar(): string
    {
        /**
