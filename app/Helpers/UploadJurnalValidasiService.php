...
class UploadJurnalValidasiService
{

    public static function kaskeluar($request){
        self::kaskeluar_form_validation($request);
        self::validasi_jurnal_header_kaskeluar($request);
        self::validasi_jurnal_detail_kaskeluar($request);
        return true;
    }

    public static function kaskeluar_form_validation($request){
        $rules = [
    ...
    private static function validasi_jurnal_header_kaskeluar($request)
    {
    ...
    private static function validasi_jurnal_detail_kaskeluar($request)
    {
        $file = $request->file('file');
        $spreadsheet = IOFactory::load($file->getRealPath());
