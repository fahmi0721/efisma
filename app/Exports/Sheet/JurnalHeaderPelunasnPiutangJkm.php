...
class JurnalHeaderPelunasnPiutangJkm implements FromArray, WithHeadings, WithTitle, WithEvents, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                 ...
                 */
                $sheet->getStyle('D2:D100')->applyFromArray([
                    'fill' => [
                        'fillType' => Fill::FILL_SOLID,
                        'startColor' => [
