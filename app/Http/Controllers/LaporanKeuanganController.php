...
class LaporanKeuanganController extends Controller
{
    ...
    public function exportNeraca(Request $request)
    {
        ...
        return Excel::download(new NeracaExport($entitas_id, $periode,$cabang_id), $filename);
    }
    ...
    public function indexBukuBesar(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $query = DB::table('buku_besar as b')
                ...
                ->when($akun_id, fn($q) => $q->where('b.akun_id', $akun_id))
    ...
    public function exportBukuBesar(Request $request)
    {
        ...
        return Excel::download(
            new BukuBesarExport($entitas, $periode,$cabang_id,$akun_id),
            $filename
        );
    }
